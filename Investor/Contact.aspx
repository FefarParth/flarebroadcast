<%@ Page Title="" Language="C#" MasterPageFile="~/Investor/InvestorMaster.master" AutoEventWireup="true" CodeFile="Contact.aspx.cs" Inherits="Contact" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">


    <asp:Table ID="Table1" runat="server" Width="1349px" bgcolor="#66FF33">
        <asp:TableRow><asp:TableCell>b</asp:TableCell></asp:TableRow>
        <asp:TableRow><asp:TableCell>j</asp:TableCell></asp:TableRow>
        <asp:TableRow>
