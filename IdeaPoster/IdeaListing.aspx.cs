...
public partial class IdeaListing : System.Web.UI.Page
{
    ...
    protected void BindGridview()
    {
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("select * from IdeaPost,SignUp,Category,City WHERE IdeaPost.Reg_id = SignUp.Reg_id AND IdeaPost.Category_id = Category.Category_id AND IdeaPost.City_id = City.City_id", con);
