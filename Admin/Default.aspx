<%@ Page Title="" Language="C#" MasterPageFile="~/FlareMaster.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" 
        DataKeyNames="Reg_id" DataSourceID="SqlDataSource1" ForeColor="#333333" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        DeleteCommand="DELETE FROM [SignUp] WHERE [Reg_id] = @original_Reg_id " 
    ...
    <asp:DropDownList ID="DropDownList1" runat="server" 
        DataSourceID="SqlDataSource2" DataTextField="Contact_number" 
        DataValueField="Reg_id">
    </asp:DropDownList>
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ConflictDetection="CompareAllValues" 
        ConnectionString="<%$ ConnectionStrings:Flare BroadcastConnectionString %>" 
        DeleteCommand="DELETE FROM [SignUp] WHERE [Reg_id] = @original_Reg_id AND [Contact_number] = @original_Contact_number" 
        InsertCommand="INSERT INTO [SignUp] ([Contact_number]) VALUES (@Contact_number)" 
        OldValuesParameterFormatString="original_{0}" 
        SelectCommand="SELECT [Contact_number], [Reg_id] FROM [SignUp]" 
        UpdateCommand="UPDATE [SignUp] SET [Contact_number] = @Contact_number WHERE [Reg_id] = @original_Reg_id AND [Contact_number] = @original_Contact_number">
        <DeleteParameters>
            <asp:Parameter Name="original_Reg_id" Type="Int32" />
            <asp:Parameter Name="original_Contact_number" Type="String" />
        </DeleteParameters>
